---
title: "Replicating Hirt et al. (2017) in a research compendium"
author:
  - Hannah Fung:
...
abstract: |
  Research compendia offer a standard way of organizing the data, code, and other digital materials associated with a publication. In this exercise, we used rrtools to create a compendium for one of the figures in Hirt et al. (2017).
keywords: |
  maximum speed; body size; research compendia
---
